...
export const colorScheme = {
  ...
  card: 'bg-light-primary dark:bg-dark-secondary border-light-border dark:border-dark-border',
  input: 'bg-light-primary dark:bg-dark-tertiary border-light-border dark:border-dark-border text-light-text dark:text-dark-text placeholder-light-text-muted dark:placeholder-dark-text-muted',
  page: 'bg-light-primary dark:bg-dark-primary text-light-text dark:text-dark-text',
  section: 'bg-light-secondary dark:bg-dark-secondary',
  modal: 'bg-light-primary dark:bg-dark-secondary border-light-border dark:border-dark-border',
};

/**
 * Get consistent background class based on theme
 */
export const getBackgroundClass = (variant: 'primary' | 'secondary' | 'tertiary' = 'primary') => {
