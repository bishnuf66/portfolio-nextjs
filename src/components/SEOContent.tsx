...
interface SEOContentProps {
    page?: "home" | "projects" | "blog" | "contact";
}

export default function SEOContent({ page = "home" }: SEOContentProps) {
    const seoContent = {
        home: {
            title: "Top Fullstack Developer Nepal - Bishnu BK | React & Next.js Expert",
            keywords: [
            ...
            description: "Bishnu BK is Nepal's top fullstack developer specializing in React, Next.js, Node.js, and modern web technologies. Best frontend and backend developer in Kathmandu, Nepal offering professional web development services."
        },
        projects: {
            ...
            description: "Explore innovative web development projects by Nepal's leading fullstack developer. Modern React, Next.js, and Node.js applications built in Kathmandu, Nepal."
        },
        blog: {
            ...
            description: "Expert web development insights and tutorials from Nepal's top fullstack developer. Learn React, Next.js, Node.js, and modern web technologies."
        },
        contact: {
            ...
            description: "Contact Nepal's top fullstack developer for professional web development services. Expert in React, Next.js, Node.js. Based in Kathmandu, Nepal."
        }
    };
                ...
                {page === "home" && (
                    <div>
                        ...
                        <p>
                            ...
                            providing exceptional web development services in Kathmandu and throughout Nepal.
                            Specializing in modern technologies including React.js, Next.js, Node.js,
                        ...
                        <p>
                            As Nepal&apos;s leading fullstack developer, Bishnu BK has extensive experience
                            with the MERN stack (MongoDB, Express.js, React, Node.js), Next.js for
                            server-side rendering, TypeScript for type-safe development, and modern
                            CSS frameworks like Tailwind CSS. Also skilled in Three.js for 3D web
                            experiences and various database technologies.
                        </p>

                        <h3>Serving Nepal and Beyond</h3>
                        <p>
                            Based in Kathmandu, Nepal, providing top-quality web development services
                            to clients across Nepal and internationally. Known for delivering modern,
                            scalable, and performance-optimized web solutions.
                        </p>
                    </div>
                )}
            </div>
