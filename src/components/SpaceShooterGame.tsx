            ...
            <div className="flex justify-center items-center gap-4">
              ...
              <div className="relative w-32 h-32">
                ...
                <button
                  ...
                  className={`absolute top-0 left-1/2 transform -translate-x-1/2 w-10 h-10 rounded-lg ${
                    touchControls.up
                      ? "bg-blue-500"
                      : isDarkMode
                      ? "bg-gray-700"
                ...
                <button
                  ...
                  className={`absolute bottom-0 left-1/2 transform -translate-x-1/2 w-10 h-10 rounded-lg ${
                    touchControls.down
                      ? "bg-blue-500"
                      : isDarkMode
                      ? "bg-gray-700"
                ...
                <button
                  ...
                  className={`absolute left-0 top-1/2 transform -translate-y-1/2 w-10 h-10 rounded-lg ${
                    touchControls.left
                      ? "bg-blue-500"
                      : isDarkMode
                      ? "bg-gray-700"
                ...
                <button
                  ...
                  className={`absolute right-0 top-1/2 transform -translate-y-1/2 w-10 h-10 rounded-lg ${
                    touchControls.right
                      ? "bg-blue-500"
                      : isDarkMode
                      ? "bg-gray-700"
