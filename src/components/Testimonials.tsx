    ...
    >
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <AnimatedSection animation="fadeIn" className="text-center mb-16">
          ...
          >
            What clients say about working with Nepal&lsquo;s top fullstack
            developer
          </p>
        </AnimatedSection>
          ...
          <div className="relative overflow-hidden rounded-2xl">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                } backdrop-blur-md rounded-2xl p-6 md:p-12 shadow-2xl border ${
                    ...
                    {testimonials[currentIndex]?.avatar_url ? (
                      <div className="relative">
                        <Image
                          ...
                          width={64}
                          height={64}
                          className="rounded-full object-cover ring-4 ring-indigo-500/20"
                        />
                      </div>
                    ) : (
                      <div
                        ...
                        } flex items-center justify-center text-2xl font-bold ring-4 ring-indigo-500/20`}
                      >
          ...
          {testimonials.length > 1 && (
            <>
              <button
                ...
                } backdrop-blur-md shadow-lg transition-all duration-300 hover:scale-110 border ${
                  isDarkMode ? "border-gray-700" : "border-gray-200"
