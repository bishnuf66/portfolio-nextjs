  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 overflow-y-auto enhanced-scrollbar">
      ...
      >
        {/* Fixed Header */}
        <div
          className={`flex justify-between items-center p-6 border-b border-gray-200 dark:border-gray-700 shrink-0 ${
            isDarkMode ? "bg-gray-800" : "bg-white"
          }`}
        >
        ...
        {/* Fixed Footer */}
        <div
          className={`border-t border-gray-200 dark:border-gray-700 p-4 flex justify-end gap-3 shrink-0 ${
            isDarkMode ? "bg-gray-800" : "bg-white"
          }`}
        >
          <button
