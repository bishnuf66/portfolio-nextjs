...
import { Upload, Image as ImageIcon, Trash2, Edit2, Star, Eye, X, Save, Plus } from "lucide-react";
...
const GalleryManager: React.FC = () => {
    ...
    const categories = ["general", "projects", "personal", "artwork", "photography"];
    ...
    const updatePendingUpload = (index: number, field: keyof ImageUpload, value: string) => {
        ...
        <div className="space-y-6">
            ...
            <div className={`${isDarkMode ? "bg-gray-800" : "bg-white"} rounded-lg p-6 shadow-lg`}>
                ...
                {pendingUploads.length > 0 && (
                    <div className="space-y-4 mb-6">
                        <h3 className="text-lg font-semibold">Pending Uploads ({pendingUploads.length})</h3>
                        <div className="grid gap-4">
                            {pendingUploads.map((upload, index) => (
                                <div
                                    key={index}
                                    className={`border rounded-lg p-4 ${isDarkMode ? "border-gray-600 bg-gray-700" : "border-gray-200 bg-gray-50"
                                        }`}
                                >
            ...
            <div className={`${isDarkMode ? "bg-gray-800" : "bg-white"} rounded-lg p-6 shadow-lg`}>
                <div className="flex justify-between items-center mb-6">
                    <h3 className="text-xl font-semibold">Gallery Images ({filteredImages.length})</h3>
                ...
                {filteredImages.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {filteredImages.map((image) => (
                            <div
                                key={image.id}
                                className={`border rounded-lg overflow-hidden ${isDarkMode ? "border-gray-600" : "border-gray-200"
