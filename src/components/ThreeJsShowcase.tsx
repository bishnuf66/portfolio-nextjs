...
import { Sparkles, ExternalLink, Code, Cpu, Globe, Database, Rocket, Search, Terminal } from "lucide-react";
...
// Tech Satellites
// -----------------------
function TechSatellite({ position, tech, icon }: { position: [number, number, number]; tech: string; icon: React.ReactNode }) {
        ...
        <group ref={ref} position={position}>
            ...
            >
                ...
                <Html distanceFactor={20} center>
                    <div className={`p-1 rounded ${hovered ? 'bg-black/70' : 'bg-transparent'}`}>
                        {icon}
                    </div>
                </Html>
            </mesh>
...
export default function TechSolarSystem() {
    ...
    const satellites = [
        { position: [1, 1, 1] as [number, number, number], tech: "Vite", icon: <Rocket size={12} /> },
        { position: [-1, 1.5, -1] as [number, number, number], tech: "Webpack", icon: <Cpu size={12} /> },
        { position: [2, -1, 0] as [number, number, number], tech: "Jest", icon: <Code size={12} /> },
    ];
    ...
    useEffect(() => {
        if (foundEasterEggs.length === planets.length + 1) { // +1 for earth
        ...
        >
            <div className="max-w-7xl mx-auto px-4 md:px-8">
                <div className="text-center mb-12">
                    ...
                    <p className={`text-lg ${isDarkMode ? "text-gray-300" : "text-gray-300"}`}>
                        Each planet represents a technology. Click to explore, find hidden easter eggs!
                    </p>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    >
                        ...
                        <div style={{ position: "absolute", right: 12, top: 12, zIndex: 30 }}>
                            <Leva
                                collapsed={true}
                                title={{ text: "Solar System Controls" }}
                                ...
                                <div className="bg-black/90 backdrop-blur-md rounded-lg border border-green-500 p-4">
                                    <div className="flex items-center justify-between mb-2">
                                        <div className="flex items-center gap-2">
                                            <Terminal size={16} className="text-green-400" />
                                            <span className="text-green-400 font-mono">dev_console</span>
                                        </div>
                                        <button
                        ...
                        <div className="absolute left-4 top-4 z-20">
                            <div className="bg-black/60 backdrop-blur-sm rounded-lg p-3 max-w-xs">
                                <h3 className="text-white font-semibold mb-2">How to Explore:</h3>
                    ...
                    {/* Tech Stack Legend */}
                    <div className={`mt-8 grid grid-cols-2 md:grid-cols-${planets.length} gap-4`}>
                        {planets.map((planet) => (
                            <div
                                key={planet.name}
                    ...
                    <div className="mt-12 text-center">
                        ...
                        <p className="mt-6 text-gray-400 text-sm">
                            Made with Three.js • Find all {planets.length + 1} hidden easter eggs to unlock achievement
                        </p>
                    </div>
                </div>
            </div>
